...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      { title: "Acessar · StockFlow Gestão" },
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="hidden md:flex gradient-hero text-primary-foreground p-10 flex-col justify-between">
        ...
        <div className="text-xs text-white/60">© {new Date().getFullYear()} Josi & Jó Eletrodomésticos</div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 bg-background">
        <div className="w-full max-w-md space-y-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-2 text-xs text-muted-foreground bg-muted/40 rounded-lg px-3 py-2.5">
                  ...
                  <span>
                    O login com Google requer <strong>aprovação do Administrador</strong> antes de liberar o acesso ao sistema.
                    Seu pedido será analisado em breve.
                  </span>
                </div>
              </div>
            </CardContent>
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            <span className="font-semibold text-foreground">Administrador do Sistema</span>{" "}
            o cadastro do seu usuário.
          </p>
        </div>
      </div>
    </div>
